...
# Find all facial features in all the faces in the image
    ...
    # Make the eyebrows into a nightmare
                d.polygon(face_landmarks['left_eyebrow'], fill=(50, 44, 29, 118))
                d.polygon(face_landmarks['right_eyebrow'], fill=(50, 44, 29, 118))
                d.line(face_landmarks['left_eyebrow'], fill=(50, 44, 29, 150))
                d.line(face_landmarks['right_eyebrow'], fill=(50, 44, 29, 150))


    # Gloss the lips
                d.polygon(face_landmarks['top_lip'], fill=(158,63,136,100))
                d.polygon(face_landmarks['bottom_lip'], fill=(158,63,136,100))
